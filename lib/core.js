    ...
    function importMethod(methodName, file, opts) {
      if (!selectedMethods[methodName]) {
        ...
        var _options = options,
            ...
            libDir = _options$libDir === undefined ? 'lib' : _options$libDir,
            _options$libraryName = _options.libraryName,
            libraryName = _options$libraryName === undefined ? defaultLibraryName : _options$libraryName,
            styleLibraryName = _options.styleLibraryName,
    ...
    return {
      visitor: {
        ...
        AssignmentExpression: function AssignmentExpression(path, _ref5) {
          ...
          var node = path.node,
              _path$hub = path.hub,
              hub = _path$hub === undefined ? {} : _path$hub; // in some strange situation, hub is undfined, don't know why.
